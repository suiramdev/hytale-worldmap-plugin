...
/**
 * Stops chunk processing. No further chunks are sent until /worldmap process start is used.
 * Usage: /worldmap process stop
 */
public class WorldmapProcessStopCommand extends AbstractPlayerCommand {

    public WorldmapProcessStopCommand() {
